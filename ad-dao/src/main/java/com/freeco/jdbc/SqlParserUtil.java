...
import com.freeco.util.ClassTypeUtil;
...
//	}
	...
	protected static void toStatementParameter(StatementParameter param, Object bean, String fieldName) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		...
		if (desc == null) {
			throw new RuntimeException("exception[" + clazz.getName() + "]propertyName[" + propertyName + "].");
		}
		Class<?> type = desc.getPropertyType();
		// System.out.println("fieldName:" + fieldName + " methodName:" + methodName + " desc:" + desc.getPropertyType());
	...
	protected static void setValue(StatementParameter param, Class<?> type, Object value) {
		...
		if (String.class.getName().equals(className)) {
			...
			throw new IllegalArgumentException("非法参数[" + className + "].");
		}
	}
}
